...
export default function Standard() {
  return (
    <main className=" w-full h-full mt-10  mb-10 relative isolate">
      ...
      <section className="mx-auto max-w-7xl px-8 max-md:px-2 py-12">
        ...
        <div className="mt-10 flex gap-8 rounded-lg bg-[#e9ecf5] p-10 py-20 shadow h-3/4 max-lg:flex-col max-lg:py-10 max-sm:py-4 max-lg:p-4">
          <div className="flex-1 leading-loose ">
            ...
            <ul className="mt-4 text-nowrap text-md text-gray-800">
              <li className="flex items-center space-x-2 my-3 max-md:my-0">
